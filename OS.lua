...
--local function flashEFI(url)
  --internet.download(url, "/Libraries/shit.lua")
  --EFI.set(fs.read("/tempEFI.lua"))
  --EFI.setLabel("Hacked EFI/BIOS")
  --fs.remove("/tempEFI.lua")
--end
--flashEFI("https://raw.githubusercontent.com/youaregod666/more-shit/master/Settingsold.app/Main.lua")
--flashEFI("https://raw.githubusercontent.com/youaregod666/more-shit/master/Settingsold.app/Icon.pic")
